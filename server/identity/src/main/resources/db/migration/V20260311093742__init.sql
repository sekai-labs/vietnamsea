...
CREATE TABLE IF NOT EXISTS oauth_credentials (
  ...
  created_at TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP,
  FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE,
  FOREIGN KEY (provider_id) REFERENCES oauth_clients(id) ON DELETE CASCADE
);
...
CREATE UNIQUE INDEX IF NOT EXISTS ux_user_active_credential
ON user_credentials(user_id)
WHERE changed_at IS NULL;
CREATE INDEX IF NOT EXISTS idx_user_credentials_user_id ON user_credentials(user_id);
CREATE INDEX IF NOT EXISTS idx_oauth_credentials_provider_user ON oauth_credentials(provider_id, provider_user_id);
